About dateutils-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dateutils-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4635&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dateutils-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dateutils` can be installed with `conda`:
...
```
mamba install dateutils
```

It is possible to list all of the versions of `dateutils` available on your platform with `conda`:
...
```
mamba search dateutils --channel conda-forge
```
...
mamba repoquery search dateutils --channel conda-forge

# List packages depending on `dateutils`:
mamba repoquery whoneeds dateutils --channel conda-forge

# List dependencies of `dateutils`:
mamba repoquery depends dateutils --channel conda-forge
```
